...
Also, now, you can reposition and resize widgets on the screen by physically dragging them around into new positions! (To use, click 'Move Widgets' and 'Resize Widgets' buttons at top of the screen).
