...
// todo -
// On shared functions for get user / check if user is logged in / etc, filter queries for users to limit only users that confirmed their user account.
// This way no one can exploit by registering, not confirming, and then spoofing session ID in api requests? 

// I think this page can mostly just be a form with the field to capture the confirmation code, and send them onward to verify-login to see if it matches.
// Dont need much code here... Right? 
...
<body>
	...
	<div class="screen">
		<div class="screen__content">
			<form id="loginForm" class="login" method="POST" action="verify-login.php?action=confirm_email_via_code">
